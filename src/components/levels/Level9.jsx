  ...
  <div className="fixed top-0 left-0 flex items-center justify-center w-full h-full bg-black bg-opacity-50">
    <div className="p-4 bg-white dark:bg-[#080917] rounded-md overflow-y-scroll max-w-[60vw] max-h-[40vh] scrollbar-thin scrollbar-thumb-purple-300 scrollbar-track-transparent">
      ...
      <li className="py-2">
        ...
        <li className="py-2">
          <span className="text-purple-600 font-bold">/move</span> <span className="text-blue-500">[amount]</span> - <em>ove the component on the linear plane by a specified amount.</em>
        </li>
        <li className="py-2">
